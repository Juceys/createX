...
class ItcSimpleSlider {
  ...
  reset() {
    let newValueX = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    let recalc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    this._autoplay("stop");
    this._elItems.classList.add(this.constructor.TRANSITION_NONE);
...
_defineProperty(ItcSimpleSlider, "EL_WRAPPER", `${ItcSimpleSlider.PREFIX}__wrapper`);
_defineProperty(ItcSimpleSlider, "EL_ITEM", `${ItcSimpleSlider.PREFIX}__item`);
_defineProperty(ItcSimpleSlider, "EL_ITEM_ACTIVE", `${ItcSimpleSlider.PREFIX}__item_active`);
_defineProperty(ItcSimpleSlider, "EL_ITEMS", `${ItcSimpleSlider.PREFIX}__items`);
_defineProperty(ItcSimpleSlider, "EL_INDICATOR", `${ItcSimpleSlider.PREFIX}__indicator`);
_defineProperty(ItcSimpleSlider, "EL_INDICATOR_ACTIVE", `${ItcSimpleSlider.PREFIX}__indicator_active`);
_defineProperty(ItcSimpleSlider, "EL_INDICATORS", `${ItcSimpleSlider.PREFIX}__indicators`);
_defineProperty(ItcSimpleSlider, "EL_CONTROL", `${ItcSimpleSlider.PREFIX}__btn`);
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".team__swiper", {
  slidesPerView: "auto",
  spaceBetween: 30,
  navigation: {
...
const tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]("benefits__tabs");
